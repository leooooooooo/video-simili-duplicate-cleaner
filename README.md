...
This app is made available via the [Apple App Store](https://apps.apple.com/us/app/video-simili-duplicate-cleaner/id1557271308), and [Microsoft Windows Store](https://www.microsoft.com/store/apps/9n3vr2kx3vxm) with a small cost in order to support further development work. You are of course free to check out the source code on GitHub, report bugs, suggest new features, and contribute code ! But please support my work via the store purchases, and do not redistribute the binary, although of course you may use the code for you own projects, no problemo !
